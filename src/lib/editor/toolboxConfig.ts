...
export const toolboxCategories: ToolboxCategory[] = [
    ...
    },
    {
        ...
        icon: "",
        commands: [
            { label: "when green flag clicked", code: "when green flag clicked\n    \nend", needsIndent: true, description: "Run when flag is clicked", blockType: "hat" },
            { label: "when ⬤ key pressed", code: 'when space key pressed\n    \nend', needsIndent: true, description: "Run when a key is pressed", blockType: "hat" },
            { label: "when this sprite clicked", code: "when this sprite clicked\n    \nend", needsIndent: true, description: "Run when sprite is clicked", blockType: "hat" },
            { label: "when I receive _", code: 'when I receive "⬤"\n    \nend', needsIndent: true, description: "Run when message received", blockType: "hat" },
            { label: "when I start as a clone", code: "when I start as a clone\n    \nend", needsIndent: true, description: "Run when clone starts", blockType: "hat" },
            ...
            // Key constants for drag-and-drop into "when _ key pressed"
            { label: "space", code: "space", description: "Space key constant", blockType: "reporter" },
            { label: "up arrow", code: "up arrow", description: "Up arrow key constant", blockType: "reporter" },
            { label: "down arrow", code: "down arrow", description: "Down arrow key constant", blockType: "reporter" },
            { label: "left arrow", code: "left arrow", description: "Left arrow key constant", blockType: "reporter" },
            { label: "right arrow", code: "right arrow", description: "Right arrow key constant", blockType: "reporter" },
        ],
    },
    {
        name: "Control",
        ...
        commands: [
            ...
            { label: "repeat _", code: "repeat ⬤\n    \nend", needsIndent: true, description: "Repeat code N times", blockType: "c-block" },
            { label: "forever", code: "forever\n    \nend", needsIndent: true, description: "Repeat forever", blockType: "c-block" },
            { label: "if _ then", code: "if ⯁ then\n    \nend", needsIndent: true, description: "Run if condition is true", blockType: "c-block" },
            ...
            { label: "repeat until _", code: "repeat until ⯁\n    \nend", needsIndent: true, description: "Repeat until condition", blockType: "c-block" },
    ...
    },
    {
        ...
        icon: "",
        commands: [
            { label: "define _", code: "define ⬤\n    \nend", needsIndent: true, description: "Define custom block", blockType: "hat" },
            { label: "define _ _", code: "define ⬤ ⬤\n    \nend", needsIndent: true, description: "Define with arguments", blockType: "hat" },
